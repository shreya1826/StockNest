    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-2'>
                <h1 className='fs-4 text-muted text-center'>To create a ticket, select a relevant topic:-</h1>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                <h4><i class="fa fa-user" aria-hidden="true"></i> Your StockNest Account</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                <h4><i class="fa fa-btc" aria-hidden="true"></i> Coin</h4>

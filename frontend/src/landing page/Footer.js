    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/StockNest.png" style={{ width: "50%" }}/>
            <p>&copy;2010 - 2025, StockNest Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <h4>Company</h4>
            ...
            <a href="" style={{textDecoration:"none", color:"black"}}>StockNest.tech</a><br />
            <a href="" style={{textDecoration:"none", color:"black"}}>Press & media</a><br />
            <a href="" style={{textDecoration:"none", color:"black"}}>StockNest cares (CSR)</a><br />
          </div>
          <div className="col">
            <h4>Support</h4>
            ...
            <a href=""style={{textDecoration:"none", color:"black"}}>S-Connect blog</a><br />
